...
import { AnimationClip, Group, Material, Object3DEventMap } from "three";
...
function Developer({ groupProps, animationName = "idle" }: DeveloperProps) {
  ...
  return (
    <group {...groupProps} dispose={null} ref={group} position-y={-3}>
